...
class Template extends Section
{
    ...
    public function display()
    {
        ...
        echo '<div class="be-col">';
        echo '<input type="number" class="be-input" id="password_length" value="16" min="1" max="100" maxlength="3" style="width:120px;" /> ';
        echo '</div>';
        echo '<div class="be-col">1 - 100 位</div>';
        echo '</div>';
    ...
    private function css()
    {
        ...
        echo '#password_results li{border:#eee 1px solid; color:#999; background-color:#fff; padding:5px; margin:5px; list-style:none; text-align:center; font-family:黑体; font-size:1.5rem;word-wrap:break-word;word-break:break-word;}';
    ...
    private function js()
    {
        ...
        echo 'if(iLength < 1) iLength = 1;';
        echo 'if(iLength > 100) iLength = 100;';
